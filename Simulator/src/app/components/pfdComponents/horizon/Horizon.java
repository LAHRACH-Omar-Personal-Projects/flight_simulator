package app.components.pfdComponents.horizon;
...
public class Horizon extends Region {
    ...
    private void initGraphics() {
        fontName      = Font.loadFont(Horizon.class.getResourceAsStream("/app/components/pfdComponents/horizon/Verdana.ttf"), 10).getName();
