package app.components.radarComponents;
...
public class AirCompass extends Region {
    ...
    private void initGraphics() {
        fontName      = Font.loadFont(AirCompass.class.getResourceAsStream("/app/components/pfdComponents/horizon/Verdana.ttf"), 10).getName();
    ...
    private void handleControlPropertyChanged(final String PROPERTY) {
        if ("RESIZE".equals(PROPERTY)) {
            ...
            double alpha   = target;
            double beta    = target + 360.0;
            double gamma   = target - 360.0;
